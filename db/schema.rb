...
ActiveRecord::Schema.define(:version => 20150112080729) do
  ...
  create_table "projects", :force => true do |t|
    ...
    t.text     "decision_requirements_2"
    t.text     "decision_requirements_3"
    t.text     "decision_requirements_4"
    t.text     "scope"
